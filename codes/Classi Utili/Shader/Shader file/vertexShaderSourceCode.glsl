...
void main()
{
	gl_Position=projection * view * model * vec4(aPos,1.0f); //gl_position is a vec4 variable. The 4th parameter of vec4 constructor is aPos.w, where this component is used for perspective division
